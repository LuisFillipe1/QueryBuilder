...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting QueryBuilder processing");
    
    let mut processor = QueryBuilderProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = QueryBuilderProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = QueryBuilderProcessor::new(false);
